...
export default async function ProductosPage({
  ...
  return (
    <div className={`${styles.container} ${isStoreMode ? styles.storeMode : ""}`}>
      <header className={styles.header}>
        ...
        <div className={styles.headerContent}>
          ...
          <div>
            <h1 className={styles.title}>Marketplace de Productos</h1>
            <p className={styles.subtitle}>
              {activeCategory
                ? `Explora nuestra selección en ${categoryLabel}`
                : "Descubre productos con beneficios exclusivos y puntos de recompensa"}
            </p>
          </div>
        </div>
      </header>
