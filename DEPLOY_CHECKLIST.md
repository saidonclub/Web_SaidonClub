...
- [x] Hacer push a GitHub (Fallido: Error 403 - Requiere nuevo Token)
...
- [x] Ejecutar `vercel --prod` para primer deploy (Fallido en remoto por `pnpm build --filter=web`, build local exitoso)
