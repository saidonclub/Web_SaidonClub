        ...
        <div className={styles.headerContent}>
          <div className={styles.headerMeta}>
            ...
            <div className={styles.headerStacks}>
              <div className={styles.stackItem}>
                <Users size={14} />
                <span>{services.length}+ profesionales activos</span>
              </div>
              <div className={styles.stackItem}>
                <Sparkles size={14} />
          ...
          <div>
            <h1 className={styles.title}>
              {activeCategory
                ? <>Servicios de <span>{categoryLabel}</span> — Expertos Locales</>
                : <>Marketplace de <span>Servicios</span> SaidonClub</>}
            </h1>
            <p className={styles.subtitle}>
              {activeCategory
                ? `Descubre profesionales verificados en ${categoryLabel}. Calidad institucional, atención personalizada y resultados reales.`
                : "Conecta con los mejores profesionales del Ecuador. Servicios verificados, atención premium y resultados garantizados para socios SaidonClub."}
            </p>
          </div>
        </div>
      </header>
