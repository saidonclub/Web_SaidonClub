...
export function ChatProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const loadInitialMessages = async () => {
      ...
      if (data) {
        const formatted = data.map((msg: Record<string, unknown>) => ({
          id: msg.id as string,
          content: msg.content as string,
          senderId: msg.sender_id as string,
          senderName: (msg.sender_name as string) || "Usuario",
          senderRole: (msg.sender_role as Message["senderRole"]) || "user",
      ...
      .on(
        ...
        { event: "INSERT", schema: "public", table: "chat_messages", filter: messageFilter },
          ...
          const formatted: Message = {
            ...
            senderName: (newMsg.sender_name as string) || "Admin",
            senderRole: (newMsg.sender_role as Message["senderRole"]) || "admin",
            timestamp: new Date(newMsg.created_at as string),
            read: false,
          };
